...
class CompanyTickets extends StatefulWidget {
  const CompanyTickets({super.key});

  @override
  State<CompanyTickets> createState() => _CompanyTicketsState();
}

class _CompanyTicketsState extends State<CompanyTickets> {
  @override
  void initState() {
    super.initState();
    fetchBuses();
